...
contract SimpleGovernance {
    ...
    event LogAddress(string reason, address _address);
    event LogBytes(string reason, bytes _bytes);
    ...
    function executeAction(uint256 actionId) external payable {
        ...
        emit LogAddress("actionToExecute.receiver", actionToExecute.receiver);
        emit LogBytes("actionToExecute.data", actionToExecute.data);
