 ...
 * npx hardhat clean && npx hardhat compile --force && echidna-test . --contract EchidnaSelfieE2E --config ./contracts/selfie/echidna/config.yaml
 */
