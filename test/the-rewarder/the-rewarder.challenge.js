...
describe('[Challenge] The rewarder', function () {
  ...
  before(async function () {
    ...
    // attach explained at https://docs.ethers.io/v5/api/contract/contract/#Contract-attach
    // attach here because it is already deployed by the Rewarder Pool from its constructor
  ...
  it('Exploit', async function () {
    ...
    const AttackOnRewarderFactory = await ethers.getContractFactory(
      'AttackOnRewarder',
      attacker
    );
    this.attackerContract = await AttackOnRewarderFactory.deploy(
      this.liquidityToken.address,
